...
class BookRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_request" do
    assert_difference('BookRequest.count') do
      post book_requests_url, params: { book_request: { book: @book_request.book, email: @book_request.email, name: @book_request.name } }
    end
  ...
  test "should update book_request" do
    patch book_request_url(@book_request), params: { book_request: { book: @book_request.book, email: @book_request.email, name: @book_request.name } }
